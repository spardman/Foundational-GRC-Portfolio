...
*   [Enterprise Risk Register](./Risk_Register.md) - *Active tracking of organizational threats and mitigations.*

---

## 🛠️ Implementation Methodology
This portfolio demonstrates the operationalization of IT Governance by bridging the gap between technical controls and business risk. 

### Key Highlights:
*   **Traceability**: Every risk is mapped to a specific mitigating policy.
